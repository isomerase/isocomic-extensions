const tags: any = {
  ...
  "5920b825-4181-4a17-beeb-9918b0ff7a30": "Boy's Love",
  ...
  "a3c67850-4684-404e-9b7f-c69850ee5da6": "Girl's Love",
  ...
  "891cf039-b895-47f0-9229-bef4c96eccd4": "User Created",
...
export function getTag(id: string): string {
  return tags[id] || "Unknown"
}